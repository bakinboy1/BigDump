...
public class BlackJack {
	...
	public static void startDeal() {
		p.getHand().addCard(dealer.dealCard());
	...
	public static void toHitOrNot() {
		...
		if(num == 1) {
			...
			hit.execute(dealer.dealCard()); //executes the hit function
	...
	public static void dealerHit() {
		...
		dealer.getHand().addCard(dealer.dealCard()); //deals card to dealer
	...
	public static void returnHands() {
		...
		for(int i = 0; i<size1;i++) {
			dealer.getDeck().addCard(p.getHand().giveCards());
		}
		//for every card in the dealers hand, add those cards back to deck 
		for(int i = 0; i<size2;i++) {
			dealer.getDeck().addCard(dealer.getHand().giveCards());
		}
	...
	public static void newGame() {
		...
		dealer.getDeck().shuffleDeck(); //shuffles the deck again
		System.out.println("\nDealing cards.....");
