@ECHO OFF
									SET "PHP_PEAR_SYSCONF_DIR=D:\school program files\wampstack\php"
...
FOR %%x IN ("D:\school program files\wampstack\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=D:\school program files\wampstack\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=D:\school program files\wampstack\php"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=D:\school program files\wampstack\php\php.exe"
GOTO :INSTALLED
