...
D:/school program files/wampstack/apache2/htdocs

This is the document root folder for Apache. You can also find the Bitnami
Welcome page into it.

Then go to your browser at http://localhost:82/phpinfo.php
...
will be accessible at http://localhost:82/demo

You should copy the "demo" folder into the D:/school program files/wampstack/apps 
folder and add the following line at the end of the
D:/school program files/wampstack/apache2/conf/bitnami/bitnami-apps-prefix.conf

Include "D:/school program files/wampstack/apps/demo/conf/httpd-prefix.conf"

Then restart the Apache server. You can use the graphical Manager tool 
that you can find in your installation directory.

Go to your browser at http://localhost:82/demo and
...
configuration in the "D:/school program files/wampstack/apache2/conf/bitnami/bitnami-apps-prefix.conf" file

#Include "D:/school program files/wampstack/apps/demo/conf/httpd-prefix.conf"

and enable the new Virtual Host configuration file in the 
"D:/school program files/wampstack/apache2/conf/bitnami/bitnami-apps-vhosts.conf" file:

Include "D:/school program files/wampstack/apps/demo/conf/httpd-vhosts.conf"
