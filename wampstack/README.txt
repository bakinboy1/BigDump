...
https://docs.bitnami.com/?page=infrastructure&name=wamp&section=how-can-i-add-applications-on-top-of-wamp
...
http://docs.bitnami.com/?page=infrastructure&name=wamp
...
bitnami-wampstack-7.1.14-0-windows-installer.exe
...
path will be a folder at C:\Bitnami\wampstack-7.1.14-0. If the destination 
...
C:\Bitnami\wampstack-7.1.14-0 and that you use port 80 for Apache and 3306 for MySQL.
